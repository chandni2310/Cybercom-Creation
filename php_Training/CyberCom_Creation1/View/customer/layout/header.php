                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="<?php echo $this->getUrl()->baseUrl('Skin/Customer/img/flag/english.jpg')?>" alt="english flag">ENGLISH
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                      <li><a href="#"><img src="<?php echo $this->getUrl()->baseUrl('Skin/Customer/img/flag/french.jpg')?>" alt="">FRENCH</a></li>
                      <li><a href="#"><img src="<?php echo $this->getUrl()->baseUrl('Skin/Customer/img/flag/english.jpg')?>" alt="">ENGLISH</a></li>
                    </ul>
                  </div>
                </div>
                <!-- / language -->
            ...
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                ...
                <div class="aa-cartbox-summary">
                  <ul>
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="<?php echo $this->getUrl()->baseUrl('Skin/Customer/img/woman-small-2.jpg')?>" alt="img"></a>
                    ...
                    <li>
                      <a class="aa-cartbox-img" href="#"><img src="<?php echo $this->getUrl()->baseUrl('Skin/Customer/img/woman-small-1.jpg')?>" alt="img"></a>
                      <div class="aa-cartbox-info">
                        <h4><a href="#">Product Name</a></h4>
                        <p>1 x $250</p>
                      </div>
      ...
      <div class="menu-area">
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            <!-- Left nav -->
            <ul class="nav navbar-nav" aria-labelledby="dropdownMenu1">
