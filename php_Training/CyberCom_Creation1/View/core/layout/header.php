...
?>
	<nav class="navtop">
    	<div>
        	...
        	<a href=<?php echo $this->getUrl()->getUrl('grid','product'); ?>>Product</a>
            <a href=<?php echo $this->getUrl()->getUrl('grid','cmsPage'); ?>>CmsPage</a>
        	<a href=<?php echo $this->getUrl()->getUrl('grid','customer'); ?>>Customer</a>
            <a href=<?php echo $this->getUrl()->getUrl('grid','customerGroup'); ?>>CustomerGroup</a>
