...
<body>
	...
	<a href="<?php echo $this->getUrl()->getUrl('form'); ?>" class="create-contact">Add Attribute</a>
	<table class="table table-bordered table-striped" >
      ...
      <td><?php echo $attribute->backendModel; ?></td>
			<td>
				<a href="<?php echo $this->getUrl()->getUrl('form', NULL, ['attributeId'=>$attribute->attributeId],true);?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
				<a href="<?php echo $this->getUrl()->getUrl('delete', NULL, ['attributeId'=>$attribute->attributeId]);?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php
		} 
