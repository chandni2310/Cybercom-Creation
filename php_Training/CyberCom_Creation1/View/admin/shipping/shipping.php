...
<html>
<head>
	<title>Shipping Method Page</title>
...
<body>
	...
	<a href="http://localhost/php_Training/Cybercom_Creation1/index.php?c=shipping&a=form" class="create-contact">Add Shipping Method</a>
	<table class="table table-bordered table-striped" >
      ...
      <td><?php echo $shipping->description; ?></td>
			...
			<td>
				<a href="<?php echo $this->getUrl()->getUrl('form', NULL, ['shippingId'=>$shipping->shippingId],true);?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
				<a href="<?php echo $this->getUrl()->getUrl('delete', NULL, ['shippingId'=>$shipping->shippingId]);?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php
		} 
