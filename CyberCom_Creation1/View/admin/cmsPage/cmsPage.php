...
<body>
	...
	<a href="<?php echo $this->getUrl()->getUrl('form'); ?>" class="create-contact">Add CMS Page</a>
	<table class="table table-bordered table-striped" >
      ...
      <td><?php echo $cmsPage->status; ?></td>
			...
			<td>
				<a href="<?php echo $this->getUrl()->getUrl('form', NULL, ['pageId'=>$cmsPage->pageId],true);?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
				<a href="<?php echo $this->getUrl()->getUrl('delete', NULL, ['pageId'=>$cmsPage->pageId],true);?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
			</td>
		</tr>
		<?php
		} 
